...
def generate_slide12():
    ...
    output_path = os.path.join(project_root, "public/imagens/SLIDES/12 - slide_natal.jpg")
    preview_path = os.path.join(project_root, "public/imagens/slide_natal_preview.jpg")
    ...
    title_text = "P L A N O  D E  A Ç Õ E S :  P I L O T O  D E  N A T A L"
    subtitle_text = "Validação local da nova experiência e-commerce antes de iniciar a captação nacional."
    ...
    columns = [
        {
            "x": x_margin,
            "title": "1. PRODUTO (LOCAL)",
            "desc": "Foco na confecção da grade de Natal com modelagem aprimorada. Teste físico da nova linha de produtos dentro da comunidade de Vitória."
        },
        {
            "x": x_margin + col_w + col_gap,
            "title": "2. SITE & STORYBOARD",
            "desc": "Lançamento do e-commerce com a nova identidade visual. Os produtos são expostos na vitrine através das poses sequenciais dirigidas pelo nosso sócio."
        },
        {
            "x": x_margin + 2 * (col_w + col_gap),
            "title": "3. COMUNIDADE ATIVA",
            "desc": "Ativações em Vitória, seeding de peças para formadores de opinião locais e tráfego pago ultra-segmentado geograficamente para Vitória/ES."
        },
        {
            "x": x_margin + 3 * (col_w + col_gap),
            "title": "4. COLETA DE DADOS",
            "desc": "Uso das vendas de Natal para extrair dados reais de conversão e ticket médio, servindo de base analítica para a primeira rodada de captação externa."
        }
    ]
