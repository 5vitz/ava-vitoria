...
def generate_slide5():
    ...
    output_path = os.path.join(project_root, "public/imagens/SLIDES/05 - slide_produto.jpg")
    preview_path = os.path.join(project_root, "public/imagens/slide_produto_preview.jpg")
    ...
    title_text = "O  P R O D U T O :  E S T R A T É G I A  D E  M Í D I A  H Í B R I D A"
    subtitle_text = "A união entre a atitude visual das ruas e a eficiência tecnológica de ponta."
    ...
    columns = [
        {
            "x": x_margin,
            "title": "1. GRADE STORIES (9:16)",
            "desc": "Vitrine de impacto baseada no grid de 3 colunas, usando fotos verticais no formato 9:16 que conversam nativamente com a linguagem visual dos Stories e Reels."
        },
        {
            "x": x_margin + col_w + col_gap,
            "title": "2. LOOKBOOKS POR IA",
            "desc": "Uso de tecnologia de Provador Virtual (VTON) para vestir modelos digitais realistas em cenários urbanos, gerando editoriais conceituais ricos sem os custos logísticos de ensaios físicos."
        },
        {
            "x": x_margin + 2 * (col_w + col_gap),
            "title": "3. GRADE SOB DEMANDA",
            "desc": "As variações de cores e contrastes de estampas são geradas diretamente na co-produção por IA. Isso nos permite lançar a grade de cores no site antes da produção física, reduzindo custos de prototipagem."
        }
    ]
