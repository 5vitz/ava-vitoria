...
export default async function RootLayout({
  ...
  const googleFontsUrl = `https://fonts.googleapis.com/css2?family=${titleFontUrl}:wght@400;600;700;800&family=${bodyFontUrl}:wght@200;300;400;500&family=Gruppo&family=Syncopate:wght@700&family=Unbounded:wght@700;900&family=Stardos+Stencil:wght@400&family=Rubik+Spray+Paint&family=Rock+Salt&display=swap`;
